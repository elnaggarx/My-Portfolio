...
import ieeeaast from "@/app/assets/images/ieee.png";
...
export const projects = [
    {
        ...
        tech: ["React Native", "Tailwind CSS", "Typescript"],
        image: ingazo,
        link: "https://ingazo.com/",
        github: "",
        myRole: "I was responsible for designing and developing the user interface of the app, as well as implementing the core features such as ride scheduling and payment processing. I also worked on optimizing the app's performance and ensuring a smooth user experience. Additionally, I collaborated with the backend team to integrate the app with the server and database, and I contributed to the overall architecture and design of the app.",
        featuresBullets: [
            "Searching for destinations: Users can search for available rides based on their location, destination, and preferred time.",
            "Drivers accept or reject ride requests: Drivers can review ride requests and choose to accept or reject them based on their preferences and availability.",
            "User Profiles: Users can create and customize their profiles, including their preferences for car pooling and their contact information.",
            "Ride Search: Users can search for available rides based on their location, destination, and preferred time.",
            "Communication: The app includes a messaging feature that allows users to communicate with each other to coordinate rides.",
            "Ride Scheduling: Users can schedule rides in advance and receive notifications about upcoming rides.",
    ...
    },
    {
        ...
        image: ieeeaast,
        link: "https://www.ieeeaastcairo.org/",
        github: "",
        myRole: "I was responsible for designing and developing the user interface of the website, as well as implementing the core features such as news management, event scheduling, tasks management for branch members. I also worked on optimizing the website's performance and ensuring a smooth user experience. Additionally, I collaborated with the backend team to integrate the website with the server and database, and I contributed to the overall architecture and design of the website.",
        featuresBullets: [
            "News Management: The website includes a content management system that allows branch members to easily create and manage news articles and updates.",
            "Event Scheduling: The website features an event calendar that allows users to view upcoming events and register for them.",
            "Tasks Management: The website includes a task management system that allows branch members to assign and track tasks related to branch activities and events.",
    ...
    },
    {
        ...
        tech: ["React", "CSS" , "JS"],
        image: eossc,
        link: "https://land.4thk.com/",
        github: "",
        myRole: "I was responsible for designing and developing the user interface of the website, as well as implementing the core features such us as responsive design, showcasing  the office's services. I also worked on optimizing the website's performance and ensuring a smooth user experience. Additionally, I collaborated with the backend team to integrate the website with the server and database, and I contributed to the overall architecture and design of the website.",
        featuresBullets: [
            "Services Showcase: The website includes a section that highlights the various services offered by the office, providing detailed descriptions and examples.",
            "Project Portfolio: The website features a portfolio section where users can view past projects completed by the office, including images and project details.",
            "Responsive Design: The website is designed to be responsive, ensuring a seamless experience across different devices and screen sizes.",
